...
Let's start with 2002, where funds still in the investment period reported rather large negative returns on average, while more mature funds had better median returns around 0%. Funds with an age of 9 years report a slightly worse performance. Overall, the patterns is very comparable to the one described above. The same is true for the 2009 cohort, where funds with age 3 to 7 are relatively the best performing funds, while the very young and more mature ones are more impacted. This is consistent with the overall pattern across all years.
