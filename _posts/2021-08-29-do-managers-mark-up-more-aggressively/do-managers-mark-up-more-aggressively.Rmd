...
```{r DataPreparation, layout="l-page", fig.cap="Dispersion of TVPIs for U.S. buyout funds, grouped by vintage year at different points in time over the fund life: after 4, 8, 12, 16, and 20 quarters (from top to bottom). Data from Preqin."}
